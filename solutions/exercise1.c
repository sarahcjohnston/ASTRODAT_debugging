...
int main()
{
	...
	while (x > 10){
		printf("%i \n", x); //could use printf debugging to check the value of x in this loop
		// or could use gdb and put in a breakpoint
		x -= 1;} //Wrong symbol on this line, need to change + to -
